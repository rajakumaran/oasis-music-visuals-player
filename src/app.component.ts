...
export class AppComponent implements OnInit, OnDestroy {
  ...
  themes: EqualizerTheme[] = [
    ...
    { name: 'Pioneer Aurora', type: 'shadow', base: 'bg-slate-950', display: 'bg-indigo-950/40', bar: 'bg-gradient-to-t from-indigo-600 via-purple-400 to-pink-200 shadow-[0_0_30px_rgba(168,85,247,0.9),-4px_0_12px_rgba(0,0,0,0.6)]', sliderTrack: 'bg-indigo-950/60', sliderThumb: 'bg-purple-400', text: 'text-purple-200', accent: 'text-pink-400', button: 'bg-indigo-900/50 border border-indigo-700/50', buttonHover: 'hover:bg-indigo-800/50', highlight: 'bg-pink-500/40' },
    ...
    { name: 'Pioneer Neon Pink', type: 'shadow', base: 'bg-slate-950', display: 'bg-pink-950/40', bar: 'bg-gradient-to-t from-pink-600 via-pink-400 to-rose-100 shadow-[0_0_30px_rgba(236,72,153,0.9),-4px_0_12px_rgba(0,0,0,0.6)]', sliderTrack: 'bg-pink-950/60', sliderThumb: 'bg-pink-400', text: 'text-pink-200', accent: 'text-pink-400', button: 'bg-pink-900/50 border border-pink-800/50', buttonHover: 'hover:bg-pink-800/50', highlight: 'bg-pink-500/40' },
    ...
    { name: 'Pioneer Teal Glow', type: 'shadow', base: 'bg-slate-950', display: 'bg-teal-950/40', bar: 'bg-gradient-to-t from-teal-500 via-teal-300 to-teal-100 shadow-[0_0_30px_rgba(20,184,166,0.95),-4px_0_12px_rgba(0,0,0,0.6)]', sliderTrack: 'bg-teal-950/60', sliderThumb: 'bg-teal-400', text: 'text-teal-200', accent: 'text-teal-400', button: 'bg-teal-900/50 border border-teal-800/50', buttonHover: 'hover:bg-teal-800/50', highlight: 'bg-teal-500/40' },
    ...
    { name: 'Pioneer Sunset', type: 'shadow', base: 'bg-slate-950', display: 'bg-orange-950/40', bar: 'bg-gradient-to-t from-orange-600 via-orange-400 to-yellow-200 shadow-[0_0_30px_rgba(249,115,22,0.9),-4px_0_12px_rgba(0,0,0,0.6)]', sliderTrack: 'bg-orange-950/60', sliderThumb: 'bg-orange-400', text: 'text-orange-200', accent: 'text-orange-400', button: 'bg-orange-900/50 border border-orange-800/50', buttonHover: 'hover:bg-orange-800/50', highlight: 'bg-orange-500/40' },
    { name: 'Marantz Ice Blue', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-cyan-600 via-cyan-300 to-white shadow-[0_0_25px_rgba(6,182,212,0.8),inset_0_2px_5px_rgba(255,255,255,0.5)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-cyan-500', text: 'text-cyan-100', accent: 'text-cyan-400', button: 'bg-zinc-900 border border-cyan-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-cyan-500/40' },
    { name: 'Marantz Shadow Purple', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-purple-600 via-purple-400 to-fuchsia-100 shadow-[0_0_30px_rgba(168,85,247,0.9),-2px_0_10px_rgba(0,0,0,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-purple-500', text: 'text-purple-100', accent: 'text-purple-400', button: 'bg-zinc-900 border border-purple-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-purple-500/40' },
    { name: 'Marantz Concave Gold', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-amber-600 via-amber-400 to-yellow-100 shadow-[0_0_25px_rgba(245,158,11,0.8),inset_0_2px_5px_rgba(255,255,255,0.5)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-amber-500', text: 'text-amber-100', accent: 'text-amber-400', button: 'bg-zinc-900 border border-amber-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-amber-500/40' },
    { name: 'Marantz Retro Green', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-green-600 via-green-400 to-lime-100 shadow-[0_0_30px_rgba(34,197,94,0.9),-2px_0_10px_rgba(0,0,0,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-green-500', text: 'text-green-100', accent: 'text-green-400', button: 'bg-zinc-900 border border-green-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-green-500/40' },
    { name: 'Marantz', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-blue-600 via-blue-400 to-cyan-100 shadow-[0_0_30px_rgba(59,130,246,0.9),-2px_0_10px_rgba(0,0,0,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-variant1', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-blue-600 via-blue-400 to-blue-200 shadow-[-2px_0_5px_rgba(0,0,0,0.6),-8px_0_25px_rgba(59,130,246,0.7)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-variant2', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-sky-600 via-sky-400 to-white shadow-[-4px_0_5px_rgba(0,0,0,0.5),-6px_0_20px_rgba(14,165,233,0.8)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-sky-500', text: 'text-sky-100', accent: 'text-sky-400', button: 'bg-zinc-900 border border-sky-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-sky-500/40' },
    { name: 'Marantz Concave', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-blue-600 via-blue-400 to-white shadow-[0_0_25px_rgba(59,130,246,0.8),inset_0_2px_5px_rgba(255,255,255,0.5)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-concave-variant1', type: 'shadow', base: 'bg-zinc-900', display: 'bg-black/50', bar: 'bg-gradient-to-t from-blue-600 via-blue-400 to-cyan-100 shadow-[-2px_0_5px_rgba(0,0,0,0.6),-8px_0_25px_rgba(59,130,246,0.8)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-concave-variant2', type: 'shadow', base: 'bg-zinc-800', display: 'bg-black/50', bar: 'bg-gradient-to-t from-lime-600 via-lime-400 to-white shadow-[-4px_0_5px_rgba(0,0,0,0.5),-6px_0_20px_rgba(132,204,22,0.8)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-lime-500', text: 'text-lime-100', accent: 'text-lime-400', button: 'bg-zinc-900 border border-lime-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-lime-500/40' },
    { name: 'Marantz-concave-variant3', type: 'concave', base: 'bg-zinc-800', display: 'bg-black/50', bar: 'bg-gradient-to-t from-rose-600 via-rose-400 to-white shadow-[inset_-1px_0_5px_rgba(255,255,255,0.6),-5px_0_15px_rgba(0,0,0,0.5)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-rose-500', text: 'text-rose-100', accent: 'text-rose-400', button: 'bg-zinc-900 border border-rose-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-rose-500/40' },
    { name: 'Marantz Fire Red', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-red-600 via-red-400 to-orange-100 shadow-[0_0_30px_rgba(239,68,68,0.9),-2px_0_10px_rgba(0,0,0,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-red-500', text: 'text-red-100', accent: 'text-red-400', button: 'bg-zinc-900 border border-red-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-red-500/40' },
    { name: 'Marantz Concave Violet', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-violet-600 via-violet-400 to-fuchsia-100 shadow-[0_0_25px_rgba(139,92,246,0.8),inset_0_2px_5px_rgba(255,255,255,0.5)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-violet-500', text: 'text-violet-100', accent: 'text-violet-400', button: 'bg-zinc-900 border border-violet-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-violet-500/40' },
    { name: 'Marantz Lava Flow', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-red-600 via-orange-400 to-yellow-100 shadow-[0_0_35px_rgba(245,158,11,0.9),-2px_0_10px_rgba(0,0,0,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-orange-500', text: 'text-orange-100', accent: 'text-orange-400', button: 'bg-zinc-900 border border-orange-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-orange-500/40' },
    { name: 'Marantz Concave Galaxy', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-purple-600 via-indigo-400 to-blue-100 shadow-[0_0_30px_rgba(99,102,241,0.8),inset_0_2px_5px_rgba(255,255,255,0.5)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-indigo-500', text: 'text-indigo-100', accent: 'text-indigo-400', button: 'bg-zinc-900 border border-indigo-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-indigo-500/40' },
    { name: 'Marantz Ocean Depth', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/50', bar: 'bg-gradient-to-t from-cyan-600 via-cyan-400 to-teal-100 shadow-[0_0_35px_rgba(20,184,166,0.9),-2px_0_10px_rgba(0,0,0,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-cyan-500', text: 'text-cyan-100', accent: 'text-cyan-400', button: 'bg-zinc-900 border border-cyan-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-cyan-500/40' },
