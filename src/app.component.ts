...
import { ReactionDiffusionGpuComponent } from './reaction-diffusion-gpu/reaction-diffusion-gpu.component';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, FullscreenToggleComponent, WebglVisualizerComponent, OscilloscopeComponent, SpectrogramComponent, ParticleStormComponent, FireworksComponent, RadarPulseComponent, TerrainPeaksComponent, CymaticsComponent, ReactionDiffusionComponent, ReactionDiffusionGpuComponent, CellularAutomataComponent],
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  themes: EqualizerTheme[] = [
    ...
    { name: 'Turing Tapestry Old', type: 'reaction-diffusion', base: 'bg-[#020206]', display: 'bg-black', bar: '', sliderTrack: 'bg-teal-900/50', sliderThumb: 'bg-teal-400', text: 'text-teal-300', accent: '#14b8a6', button: 'bg-teal-900/70', buttonHover: 'hover:bg-teal-800/70', highlight: 'bg-teal-500/50' },
    { name: 'Turing Tapestry Refined', type: 'reaction-diffusion-gpu', base: 'bg-[#020206]', display: 'bg-black', bar: '', sliderTrack: 'bg-teal-900/50', sliderThumb: 'bg-teal-400', text: 'text-teal-300', accent: '#14b8a6', button: 'bg-teal-900/70', buttonHover: 'hover:bg-teal-800/70', highlight: 'bg-teal-500/50' },
    ...
    { name: 'Gold Standard Prism', type: 'convex', base: 'bg-gray-950', display: 'bg-black/70 backdrop-blur-md', bar: 'bg-gradient-to-t from-lime-900 via-green-400 to-teal-100 shadow-[0_0_15px_rgba(34,197,94,0.6),inset_0_2px_5px_rgba(255,255,255,0.5)]', sliderTrack: 'bg-lime-900/40', sliderThumb: 'bg-green-400', text: 'text-green-100', accent: 'text-lime-400', button: 'bg-lime-950/60 border border-lime-800/50', buttonHover: 'hover:bg-lime-900/60', highlight: 'bg-green-500/40' },
    { name: 'Gold Standard', type: 'convex', base: 'bg-gray-950', display: 'bg-black/70 backdrop-blur-md', bar: 'bg-gradient-to-t from-yellow-900 via-amber-400 to-yellow-100 shadow-[0_0_15px_rgba(250,204,21,0.6),inset_0_2px_5px_rgba(255,255,255,0.5)]', sliderTrack: 'bg-yellow-900/40', sliderThumb: 'bg-amber-400', text: 'text-amber-100', accent: 'text-yellow-400', button: 'bg-yellow-950/60 border border-yellow-800/50', buttonHover: 'hover:bg-yellow-900/60', highlight: 'bg-amber-500/40' },
    { name: 'Gold Standard Fire Opal', type: 'convex', base: 'bg-gray-950', display: 'bg-black/70 backdrop-blur-md', bar: 'bg-gradient-to-t from-red-900 via-rose-500 to-pink-100 shadow-[0_0_15px_rgba(244,63,94,0.6),inset_0_2px_5px_rgba(255,255,255,0.5)]', sliderTrack: 'bg-rose-900/40', sliderThumb: 'bg-rose-400', text: 'text-rose-100', accent: 'text-rose-400', button: 'bg-rose-950/60 border border-rose-800/50', buttonHover: 'hover:bg-rose-900/60', highlight: 'bg-rose-500/40' },
    { name: 'Gold Standard Sapphire', type: 'convex', base: 'bg-gray-950', display: 'bg-black/70 backdrop-blur-md', bar: 'bg-gradient-to-t from-blue-900 via-indigo-500 to-blue-100 shadow-[0_0_15px_rgba(99,102,241,0.6),inset_0_2px_5px_rgba(255,255,255,0.5)]', sliderTrack: 'bg-indigo-900/40', sliderThumb: 'bg-indigo-400', text: 'text-indigo-100', accent: 'text-indigo-400', button: 'bg-indigo-950/60 border border-indigo-800/50', buttonHover: 'hover:bg-indigo-900/60', highlight: 'bg-indigo-500/40' },
    { name: 'Gold Standard Crimson', type: 'convex', base: 'bg-gray-950', display: 'bg-black/70 backdrop-blur-md', bar: 'bg-gradient-to-t from-rose-900 via-red-500 to-rose-100 shadow-[0_0_15px_rgba(225,29,72,0.6),inset_0_2px_5px_rgba(255,255,255,0.5)]', sliderTrack: 'bg-rose-950/40', sliderThumb: 'bg-red-400', text: 'text-red-100', accent: 'text-rose-400', button: 'bg-rose-900/40 border border-rose-800/50', buttonHover: 'hover:bg-rose-800/50', highlight: 'bg-red-500/40' },
    { name: 'Gold Standard Emerald', type: 'convex', base: 'bg-gray-950', display: 'bg-black/70 backdrop-blur-md', bar: 'bg-gradient-to-t from-emerald-900 via-emerald-500 to-emerald-100 shadow-[0_0_15px_rgba(16,185,129,0.6),inset_0_2px_5px_rgba(255,255,255,0.5)]', sliderTrack: 'bg-emerald-900/40', sliderThumb: 'bg-emerald-400', text: 'text-emerald-100', accent: 'text-emerald-400', button: 'bg-emerald-950/60 border border-emerald-800/50', buttonHover: 'hover:bg-emerald-900/60', highlight: 'bg-emerald-500/40' },
    { name: 'Pioneer Aurora', type: 'shadow', base: 'bg-slate-950', display: 'bg-indigo-950/60', bar: 'bg-gradient-to-t from-indigo-800 via-purple-400 to-pink-200 shadow-[0_0_25px_rgba(168,85,247,0.8),0_0_8px_rgba(168,85,247,0.4)]', sliderTrack: 'bg-indigo-950/60', sliderThumb: 'bg-purple-400', text: 'text-purple-200', accent: 'text-pink-400', button: 'bg-indigo-900/50 border border-indigo-700/50', buttonHover: 'hover:bg-indigo-800/50', highlight: 'bg-pink-500/40' },
    { name: 'Pioneer Convex Nebula', type: 'convex', base: 'bg-slate-950', display: 'bg-cyan-950/70', bar: 'bg-gradient-to-t from-cyan-900 via-cyan-400 to-blue-100 shadow-[0_0_20px_rgba(6,182,212,0.8),inset_0_2px_5px_rgba(255,255,255,0.6)]', sliderTrack: 'bg-cyan-950/60', sliderThumb: 'bg-cyan-400', text: 'text-cyan-100', accent: 'text-cyan-400', button: 'bg-cyan-900/50 border border-cyan-800/50', buttonHover: 'hover:bg-cyan-800/50', highlight: 'bg-cyan-500/40' },
    ...
    { name: 'Pioneer Neon Circuit', type: 'shadow', base: 'bg-slate-950', display: 'bg-lime-950/60', bar: 'bg-gradient-to-t from-lime-800 via-lime-400 to-green-100 shadow-[0_0_25px_rgba(132,204,22,0.8),0_0_8px_rgba(132,204,22,0.4)]', sliderTrack: 'bg-lime-950/60', sliderThumb: 'bg-lime-400', text: 'text-lime-200', accent: 'text-lime-400', button: 'bg-lime-900/50 border border-lime-800/50', buttonHover: 'hover:bg-lime-800/50', highlight: 'bg-lime-500/40' },
    // no-show this one{ name: 'Pioneer', type: 'shadow', base: 'bg-slate-950', display: 'bg-blue-950/70', bar: 'bg-gradient-to-t from-blue-900 via-blue-500 to-blue-200 shadow-[0_0_25px_rgba(59,130,246,0.8),-4px_0_10px_rgba(0,0,0,0.8)]', sliderTrack: 'bg-blue-950/60', sliderThumb: 'bg-blue-400', text: 'text-blue-200', accent: 'text-blue-400', button: 'bg-blue-900/50 border border-blue-800/50', buttonHover: 'hover:bg-blue-800/50', highlight: 'bg-blue-500/40' },
    { name: 'Pioneer', type: 'shadow', base: 'bg-slate-200', display: 'bg-blue-900/80', bar: 'bg-gradient-to-t from-sky-600 to-sky-400 shadow-[0_0_8px_#38bdf8,0_0_5px_rgba(56,189,248,0.4)] rounded-t-sm', sliderTrack: 'bg-gray-400', sliderThumb: 'bg-white', text: 'text-gray-800', accent: 'text-blue-600', button: 'bg-gray-400', buttonHover: 'hover:bg-gray-500', highlight: 'bg-slate-300' },
    ...
    { name: 'Pioneer Neon Pink', type: 'shadow', base: 'bg-slate-950', display: 'bg-pink-950/60', bar: 'bg-gradient-to-t from-pink-800 via-pink-400 to-rose-100 shadow-[0_0_25px_rgba(236,72,153,0.8),0_0_8px_rgba(236,72,153,0.4)]', sliderTrack: 'bg-pink-950/60', sliderThumb: 'bg-pink-400', text: 'text-pink-200', accent: 'text-pink-400', button: 'bg-pink-900/50 border border-pink-800/50', buttonHover: 'hover:bg-pink-800/50', highlight: 'bg-pink-500/40' },
    ...
    { name: 'Pioneer Convex Lime', type: 'convex', base: 'bg-slate-950', display: 'bg-lime-950/70', bar: 'bg-gradient-to-t from-lime-900 via-lime-500 to-lime-100 shadow-[0_0_20px_rgba(132,204,22,0.8),inset_0_2px_5px_rgba(255,255,255,0.6)]', sliderTrack: 'bg-lime-950/60', sliderThumb: 'bg-lime-400', text: 'text-lime-100', accent: 'text-lime-400', button: 'bg-lime-900/50 border border-lime-800/50', buttonHover: 'hover:bg-lime-800/50', highlight: 'bg-lime-500/40' },
    { name: 'Pioneer Teal Glow', type: 'shadow', base: 'bg-slate-950', display: 'bg-teal-950/60', bar: 'bg-gradient-to-t from-teal-800 via-teal-400 to-teal-100 shadow-[0_0_25px_rgba(20,184,166,0.8),0_0_8px_rgba(20,184,166,0.4)]', sliderTrack: 'bg-teal-950/60', sliderThumb: 'bg-teal-400', text: 'text-teal-200', accent: 'text-teal-400', button: 'bg-teal-900/50 border border-teal-800/50', buttonHover: 'hover:bg-teal-800/50', highlight: 'bg-teal-500/40' },
    { name: 'Pioneer Convex Fuchsia', type: 'convex', base: 'bg-slate-950', display: 'bg-fuchsia-950/70', bar: 'bg-gradient-to-t from-fuchsia-900 via-fuchsia-500 to-fuchsia-100 shadow-[0_0_20px_rgba(217,70,239,0.8),inset_0_2px_5px_rgba(255,255,255,0.6)]', sliderTrack: 'bg-fuchsia-950/60', sliderThumb: 'bg-fuchsia-400', text: 'text-fuchsia-100', accent: 'text-fuchsia-400', button: 'bg-fuchsia-900/50 border border-fuchsia-800/50', buttonHover: 'hover:bg-fuchsia-800/50', highlight: 'bg-fuchsia-500/40' },
    { name: 'Pioneer Sunset', type: 'shadow', base: 'bg-slate-950', display: 'bg-orange-950/60', bar: 'bg-gradient-to-t from-orange-800 via-orange-400 to-yellow-200 shadow-[0_0_25px_rgba(249,115,22,0.8),0_0_8px_rgba(249,115,22,0.4)]', sliderTrack: 'bg-orange-950/60', sliderThumb: 'bg-orange-400', text: 'text-orange-200', accent: 'text-orange-400', button: 'bg-orange-900/50 border border-orange-800/50', buttonHover: 'hover:bg-orange-800/50', highlight: 'bg-orange-500/40' },
    { name: 'Marantz Ice Blue', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-cyan-800 via-cyan-400 to-white shadow-[0_0_20px_rgba(6,182,212,0.7),inset_0_2px_5px_rgba(255,255,255,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-cyan-500', text: 'text-cyan-100', accent: 'text-cyan-400', button: 'bg-zinc-900 border border-cyan-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-cyan-500/40' },
    { name: 'Marantz Shadow Purple', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-purple-800 via-purple-400 to-fuchsia-100 shadow-[0_0_25px_rgba(168,85,247,0.8),0_0_8px_rgba(168,85,247,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-purple-500', text: 'text-purple-100', accent: 'text-purple-400', button: 'bg-zinc-900 border border-purple-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-purple-500/40' },
    { name: 'Marantz Concave Gold', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-amber-800 via-amber-400 to-yellow-100 shadow-[0_0_20px_rgba(245,158,11,0.7),inset_0_2px_5px_rgba(255,255,255,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-amber-500', text: 'text-amber-100', accent: 'text-amber-400', button: 'bg-zinc-900 border border-amber-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-amber-500/40' },
    { name: 'Marantz Retro Green', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-green-800 via-green-400 to-lime-100 shadow-[0_0_25px_rgba(34,197,94,0.8),0_0_8px_rgba(34,197,94,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-green-500', text: 'text-green-100', accent: 'text-green-400', button: 'bg-zinc-900 border border-green-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-green-500/40' },
    { name: 'Marantz', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-blue-800 via-blue-400 to-cyan-100 shadow-[0_0_25px_rgba(59,130,246,0.8),0_0_8px_rgba(59,130,246,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-variant1', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-blue-800 via-blue-400 to-blue-200 shadow-[0_0_8px_rgba(59,130,246,0.5),0_0_20px_rgba(59,130,246,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-variant2', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-sky-800 via-sky-400 to-white shadow-[0_0_8px_rgba(14,165,233,0.5),0_0_20px_rgba(14,165,233,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-sky-500', text: 'text-sky-100', accent: 'text-sky-400', button: 'bg-zinc-900 border border-sky-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-sky-500/40' },
    { name: 'Marantz Concave', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-blue-800 via-blue-400 to-white shadow-[0_0_20px_rgba(59,130,246,0.7),inset_0_2px_5px_rgba(255,255,255,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-concave-variant1', type: 'shadow', base: 'bg-zinc-900', display: 'bg-black/60', bar: 'bg-gradient-to-t from-blue-800 via-blue-400 to-cyan-100 shadow-[0_0_8px_rgba(59,130,246,0.5),0_0_20px_rgba(59,130,246,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-blue-500', text: 'text-blue-100', accent: 'text-blue-400', button: 'bg-zinc-900 border border-blue-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-blue-500/40' },
    { name: 'Marantz-concave-variant2', type: 'shadow', base: 'bg-zinc-800', display: 'bg-black/60', bar: 'bg-gradient-to-t from-lime-800 via-lime-400 to-white shadow-[0_0_8px_rgba(132,204,22,0.5),0_0_20px_rgba(132,204,22,0.6)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-lime-500', text: 'text-lime-100', accent: 'text-lime-400', button: 'bg-zinc-900 border border-lime-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-lime-500/40' },
    { name: 'Marantz-concave-variant3', type: 'concave', base: 'bg-zinc-800', display: 'bg-black/60', bar: 'bg-gradient-to-t from-rose-800 via-rose-400 to-white shadow-[inset_0_0_5px_rgba(255,255,255,0.4),0_0_15px_rgba(244,63,94,0.5)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-rose-500', text: 'text-rose-100', accent: 'text-rose-400', button: 'bg-zinc-900 border border-rose-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-rose-500/40' },
    { name: 'Marantz Fire Red', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-red-800 via-red-400 to-orange-100 shadow-[0_0_25px_rgba(239,68,68,0.8),0_0_8px_rgba(239,68,68,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-red-500', text: 'text-red-100', accent: 'text-red-400', button: 'bg-zinc-900 border border-red-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-red-500/40' },
    { name: 'Marantz Concave Violet', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-violet-800 via-violet-400 to-fuchsia-100 shadow-[0_0_20px_rgba(139,92,246,0.7),inset_0_2px_5px_rgba(255,255,255,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-violet-500', text: 'text-violet-100', accent: 'text-violet-400', button: 'bg-zinc-900 border border-violet-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-violet-500/40' },
    { name: 'Marantz Lava Flow', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-red-800 via-orange-400 to-yellow-100 shadow-[0_0_25px_rgba(245,158,11,0.8),0_0_8px_rgba(245,158,11,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-orange-500', text: 'text-orange-100', accent: 'text-orange-400', button: 'bg-zinc-900 border border-orange-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-orange-500/40' },
    { name: 'Marantz Concave Galaxy', type: 'concave', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-purple-800 via-indigo-400 to-blue-100 shadow-[0_0_20px_rgba(99,102,241,0.7),inset_0_2px_5px_rgba(255,255,255,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-indigo-500', text: 'text-indigo-100', accent: 'text-indigo-400', button: 'bg-zinc-900 border border-indigo-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-indigo-500/40' },
    { name: 'Marantz Ocean Depth', type: 'shadow', base: 'bg-zinc-950', display: 'bg-black/60', bar: 'bg-gradient-to-t from-cyan-800 via-cyan-400 to-teal-100 shadow-[0_0_25px_rgba(20,184,166,0.8),0_0_8px_rgba(20,184,166,0.4)] rounded-t-sm', sliderTrack: 'bg-zinc-800', sliderThumb: 'bg-cyan-500', text: 'text-cyan-100', accent: 'text-cyan-400', button: 'bg-zinc-900 border border-cyan-900/50', buttonHover: 'hover:bg-zinc-800', highlight: 'bg-cyan-500/40' },
  ...
  readonly ATMOSPHERES: AtmosphereConfig[] = [
    {
      ...
      themeNames: ['Cymatics', 'Nova', 'Ripple Field', 'Polar Rose Bloom', 'Diamond Cascade', 'Orbit Rings', 'Celestial Sphere', 'Turing Tapestry Refined', 'Turing Tapestry Old'],
    ...
    },
    {
      ...
      themeNames: ['Turing Tapestry Refined', 'Polar Rose Bloom', 'Diamond Cascade', 'Orbit Rings', 'Ripple Field', 'Celestial Sphere', 'Ocean Floor', 'Aquamarine Dream', 'Nova', 'Turing Tapestry Old'],
      engine: 'pure-stft', synergyDrive: 'atmosphere', kaleidoscope: true,
    ...
    },
    {
      ...
      themeNames: ['Cymatics', 'Strange Attractor', 'Turing Tapestry Refined', 'Game of Life', 'Infinite Menger'],
      engine: 'pure-stft', synergyDrive: 'smart', kaleidoscope: false,
